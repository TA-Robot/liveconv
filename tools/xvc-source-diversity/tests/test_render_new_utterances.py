...
def test_real_speaker_condition_prebinds_complete_five_surface_contract() -> None:
    kinds = [
...
def test_src4vc_two_utterance_control_broad_policies_share_exp327_to_exp332() -> None:
    kinds = [
    ...
    expected_result_kinds = [
        "liveconv-exp-327-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-fresh48/v1",
        "liveconv-exp-328-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-hadou31/v1",
        "liveconv-exp-329-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-stress60/v1",
        "liveconv-exp-330-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-jsut24/v1",
        "liveconv-exp-331-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-expanded144/v1",
        "liveconv-exp-332-xvc-src4vc-two-utterance-control-"
        "pseudoparallel-ema-heldout30/v1",
    ]
    policies = [NEW.candidate_policy(kind) for kind in kinds]
