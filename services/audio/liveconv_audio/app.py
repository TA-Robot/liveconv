...
class Connection:
    def __init__(
        ...
        self.active_frame_task: asyncio.Task[PcmFrame] | None = None
    ...
    async def stop_tasks(self) -> None:
        self.stopping = True
        for task in (self.drain_task, self.worker_task):
...
class Gateway:
    def __init__(
        ...
        *,
        ...
        self.registry = ProfileRegistry.load(settings.profile_config)
