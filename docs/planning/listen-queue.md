...
| EXP-176--178 X-VC paired PCGrad | Base, control69, and hard-repair/retention gradient surgery across external7, fresh48, and Hadou31 | after hearing returns: optional diagnosis of the 46 fresh and 30 Hadou non-gross rows; do not promote this checkpoint | method is technically rejected because 74/85 pairs really conflicted yet the candidate still added the `RECITATION324_138` repeated-`三、四` collapse; stress60 and JSUT24 were stopped |
