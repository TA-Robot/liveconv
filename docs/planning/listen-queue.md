...
| EXP-163--167 X-VC EMA survivor | Base, control69, and selective real-adversarial EMA across external7, fresh48, Hadou31, stress60, and balanced JSUT24 | after hearing returns: judge naturalness, target-voice fit, and stability across corpora/conditions; reject all if gains are not audible | exact checkpoint survived coarse corruption gates with no candidate-added gross loop; this is unselected, not a keep or promotion |
