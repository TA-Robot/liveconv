...
| EXP-181--183 X-VC parameter anchor | Base, control69, and the exact EXP-163 method plus a light control69 L2-SP anchor on external7, fresh48, and Hadou31 | after hearing returns: judge whether the constrained adapter improves naturalness or identity without flattening conversion | 430 WAVs add no consensus gross row; fresh36 regressed source-relative content while Hadou24 improved slightly, so stress60 is the decisive condition-retention map; no automatic winner |
