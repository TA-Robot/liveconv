...
| EXP-191 X-VC conditioned retention | Base, control69, and condition-balanced control69 retention on external7 | after hearing returns: judge naturalness and identity; do not infer either from ASR | 35 WAVs; no gross row; external7 common-stable content diagnostics improve, so the unchanged checkpoint is admitted to fresh48 but remains unselected |
