...
| EXP-181--184 X-VC parameter anchor | Base, control69, and the exact EXP-163 method plus a light control69 L2-SP anchor across external7, fresh48, Hadou31, and stress60 | after hearing returns: judge whether the constrained adapter improves naturalness or identity without flattening conversion | 730 WAVs add no consensus gross row; clean/noise improved but fresh, pitch, silence, and tempo were weak, so this is mixed and the JSUT24 spend awaits the progress audit; no automatic winner |
