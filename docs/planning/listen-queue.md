...
| EXP-181 X-VC parameter anchor | Base, control69, and the exact EXP-163 method plus a light control69 L2-SP anchor on external7 | after hearing returns: judge whether the constrained adapter improves naturalness or identity without flattening conversion | 35 WAVs have no consensus gross row; external5 common-stable content is mixed, and fresh48 is the next frozen gate; no automatic winner |
