...
| EXP-176--178 X-VC paired PCGrad | Base, control69, and hard-repair/retention gradient surgery across external7, fresh48, and Hadou31 | v3 greedy/beam-consensus machine reassessment first; after hearing returns judge naturalness and identity without treating ASR as a winner | beam-5-only gross rejection is retracted: the 2.4 s source itself hallucinated 428 characters while greedy gave short plausible text and matched candidate/control; checkpoint remains unselected pending v3 |
