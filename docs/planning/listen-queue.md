...
| EXP-259--264 X-VC speaker-condition calibrator | Frozen EXP-238 plus one trained 192-value target-speaker condition delta across external7, fresh48, Hadou31, stress60, JSUT24, and expanded144 | after hearing returns judge identity/naturalness only if broad content survives; do not infer preference from cosine or ASR | 170 updates complete; external7 changed 7/7 WAVs with no new gross row and tied EXP-238 on six exact stable rows; broad five-surface render admitted, no PCGrad, speaker7, loss-weight, data, scope, LR, or horizon neighbor |
