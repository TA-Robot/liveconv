...
| EXP-191--192 X-VC conditioned retention | Base, control69, and condition-balanced control69 retention on external7 and disjoint-speaker fresh48 | after hearing returns: judge naturalness and identity; do not infer either from ASR | 275 WAVs; no candidate-added gross row; external7 improves while fresh48 is nearly flat/mixed, so the unchanged checkpoint is admitted only to the final stress60 test and remains unselected |
